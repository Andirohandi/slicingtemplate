...
<body>
	...
	<nav id="menu">
		<ul>
			<li><a hre="index.php"> Home</a></li>
			<li><a hre="about.php"> About</a></li>
			<li><a hre="contact.php"> Contact</a></li>
		</ul>
	</nav>
	<div id="slider"></div>
	<div id="herotext">
	...
	<section id="content" class="container">
		...
		<article id="artikel">
			...
			<figure>
				<img src="img/jalanan.jpg" alt="Jalan Sepi London" width="390" height="244">
